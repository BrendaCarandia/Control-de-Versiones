...
public:
	...
	// Función para obtener la traslación del coche y helicoptero
	GLfloat getmovercarro() { return movercarro; }
	GLfloat getmoverhelicoptero() { return moverhelicoptero; }
...
private:
	...
	GLfloat rotax, rotay, rotaz, cofre, movercarro, moverhelicoptero;
