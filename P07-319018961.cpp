...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//// ----> Mover la luz <----
		//	//luz fija
		//float carZ = mainWindow.getmovercarro();
		//spotLights[1] = SpotLight(0.0f, 0.0f, 1.0f,
		//	1.0f, 2.0f, //atenuacion
		//	15.0f, 16.0f, carZ - 15.0f,
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-5.0f, 15.0f, 70.0));
		model = glm::translate(model, glm::vec3(mainWindow.getmoverhelicoptero(), 3.0f, 0.0f)); //Traslacion del helicoptero en X
		model = glm::scale(model, glm::vec3(8.3f, 8.3f, 8.3f));
		model = glm::rotate(model, -90 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Blackhawk_M.RenderModel();
		spotLights[1].SetPos(glm::vec3(mainWindow.getmoverhelicoptero(),15.0f, 70.0f)); // Spotlight debajo del helicóptero, Posicion
		
		//lampara
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-6.0f, 7.0f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		lampara.RenderModel();
